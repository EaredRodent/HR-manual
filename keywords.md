# Common
- **Use-Case** - (юс кейс) - сценарий использования, например процесс оформления и оплаты заказа.
- **Feature** - (фича) - какая-то конкретная функциональность, например наличие корзины на сайте, режим для слабовидящих, темная тема, возможность использовать емодзи в комментариях и т.д.
...
# QA - (тестирование)
- **Test-Case** - (тест кейс) - сценарий тестирования, обычно 1 в 1 повторяющий Use-Case.
- **Test suite** - (тест сьют) - набор Test Case. Например тест сьют для раздела каталог.
- **Manual** - (мэньюл тестирование) - ручное тестирование.
